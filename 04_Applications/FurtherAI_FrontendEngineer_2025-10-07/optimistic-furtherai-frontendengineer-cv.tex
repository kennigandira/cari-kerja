...
% Tailored for: FurtherAI - Frontend Engineer (Optimistic Version)
%------------------------
...
\section{Work Experience}
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{Architected and deployed web application revamp driving 27\% increase in user traffic within Q3 through strategic performance improvements and enhanced user experience.}
                \resumeItem{Partnered with UI/UX designers to transform Figma designs into production-ready React and TypeScript components, ensuring pixel-perfect implementation and optimal user experience.}
                \resumeItem{Modernized technology stacks across multiple web properties, improving performance, security, and maintainability for enhanced platform stability.}
                \resumeItem{Enhanced internal operational tools using modern frontend frameworks, increasing team productivity and workflow efficiency.}
            \resumeItemListEnd
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{Architected and developed WordPress-based university platform (UPH) with custom functionality tailored to complex educational requirements.}
                \resumeItem{Engineered customizable solutions for intricate client requirements using PHP and JavaScript, delivering flexible and maintainable systems.}
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{Managed customer support and product iterations, maintaining high customer satisfaction and product quality.}
            \resumeItemListEnd

        \resumeSubheading
            {Front End Developer}{PT NTCI, Yogyakarta, Indonesia}{March 2016 -- March 2017}{}
            \resumeItemListStart
                \resumeItem{Launched career as software engineer, building multiple production applications including e-learning and ticket booking platforms.}
                ...
                \resumeItem{Took on dual role as frontend developer and UI/UX designer, demonstrating versatility and comprehensive product development skills.}
            \resumeItemListEnd
