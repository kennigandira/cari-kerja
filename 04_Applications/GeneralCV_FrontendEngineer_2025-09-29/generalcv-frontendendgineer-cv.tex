...
\section{Key Achievements}
    \resumeSubHeadingListStart
        \resumeProjectHeading
            {\textbf{PropertyScout Performance:} 27\% increase in user traffic (Q3) through web application revamp}{}
        \resumeProjectHeading
            {\textbf{AccelByte Optimization:} 40\% reduction in compilation time through developer experience improvements}{}
        \resumeProjectHeading
            {\textbf{99.co Core Web Vitals:} LCP improvement from 4.5s to 1.2s through performance optimization}{}
        \resumeProjectHeading
