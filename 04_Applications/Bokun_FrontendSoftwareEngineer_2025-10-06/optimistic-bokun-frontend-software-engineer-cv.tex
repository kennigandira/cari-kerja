...
\section{Work Experience}
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{Architected comprehensive web application revamp driving 27\% increase in user traffic through modern React implementation and strategic UX optimization.}
                \resumeItem{Optimized Core Web Vitals achieving exceptional 1.2-second page load times, delivering seamless mobile and desktop user experiences.}
                \resumeItem{Transformed Figma designs into pixel-perfect, production-ready responsive components through close collaboration with UI/UX design team.}
                \resumeItem{Engineered robust RESTful API integrations powering real-time property listing platform with 17,000+ monthly updates.}
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{Architected and deployed WordPress-based platform for Pelita Harapan University (UPH), successfully serving 30,000+ students.}
