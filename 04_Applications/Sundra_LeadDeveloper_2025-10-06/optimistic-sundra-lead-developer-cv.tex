...
\section{Work Experience}
    \resumeSubHeadingListStart
      ...
      \resumeSubheading
        ...
        {Bangkok, Thailand}
        \resumeItemListStart
          \resumeItem{Architected and executed Vue.js application revamp delivering \textbf{27\% increase in user traffic} (Q3)}
          \resumeItem{Drove technology stack modernization initiatives for optimal performance and security}
      ...
      \resumeSubheading
        ...
        \resumeItemListStart
          ...
          \resumeItem{\textbf{Reduced compilation time by 40\%} through strategic build optimization and toolchain improvements}
          \resumeItem{Established component library standards and comprehensive Storybook documentation}
          \resumeItem{Led knowledge-sharing initiatives and drove code convention standardization across engineering team}
          \resumeItem{Excelled in distributed remote team environment collaborating across multiple time zones}
