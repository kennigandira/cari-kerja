...
\section{Work Experience}
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{Revamped web applications resulting in 27\% increase in user traffic through modern React implementation and UX optimization.}
                \resumeItem{Optimized Core Web Vitals achieving page load time of 1.2 seconds, improving mobile and desktop performance.}
                \resumeItem{Collaborated with UI/UX designers to transform Figma designs into responsive, pixel-perfect web components.}
                \resumeItem{Integrated RESTful APIs for property listing management, handling 17k monthly updates.}
                \resumeItem{Improved internal tools enhancing operational productivity for the development team.}
            \resumeItemListEnd
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{Reduced compilation time from 15 to 9 minutes (40\% improvement) by optimizing Webpack configuration and build processes.}
                \resumeItem{Established component styling standards and documentation using Storybook for design system consistency.}
                \resumeItem{Optimized frontend performance by implementing efficient data fetching patterns and image asset optimization.}
                \resumeItem{Initiated knowledge-sharing sessions to standardize code conventions across the team.}
            \resumeItemListEnd
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{Contributed to expanding development team from 3 to 15 members.}
                \resumeItem{Participated in establishing development standards and best practices for code quality.}
                \resumeItem{Took on dual role as frontend developer and UI/UX designer for multiple projects.}
            \resumeItemListEnd
