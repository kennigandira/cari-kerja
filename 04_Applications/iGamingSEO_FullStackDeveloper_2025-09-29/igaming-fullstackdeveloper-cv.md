...
- Participated in web application revamp resulting in 27% increase in user traffic (Q3)
...
- Implemented SEO improvements and performance optimizations
...
- Received "Own It" award for product ownership and initiative
...
- Conducted regular refactoring for improved code scalability
- Coordinated with product team for UX enhancements

### Mirum Agency | Frontend Developer
**July 2018 - August 2019** | Bandung, Indonesia

- Developed WordPress-based university platform solutions
